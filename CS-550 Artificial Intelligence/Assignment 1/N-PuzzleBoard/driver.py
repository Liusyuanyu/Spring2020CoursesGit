...
#     b = TileBoard(size, multiple_solutions=True)
    # b = TileBoard(size, force_state=(8,None,6,5,4,7,2,3,1))
    # b = TileBoard(size, force_state=(1,None,2,3,4,5,6,7,8))
#     b = TileBoard(size,multiple_solutions=True, force_state=(None, 2, 3, 1,4,5,6,7,8))
    b = TileBoard(size,multiple_solutions=False, force_state=(1, 2, 3, 4, None, 5, 7, 8, 6))
#     b = TileBoard(size,multiple_solutions=True, force_state=(None, 2, 3, 1, 4, 5, 6, 7, 8))
    # b = TileBoard(size)
    # print(b)
    solved = b.solved()
